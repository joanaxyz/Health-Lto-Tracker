(function () {
    ...
    while (gr.next()) {
        data.alerts.push({
            ...
            license_number:
                gr.x_1998335_health_l_license_id.x_1998335_health_l_license_number.toString(),
            license_sys_id: gr.x_1998335_health_l_license_id.toString(),
            facility:
                gr.x_1998335_health_l_license_id.x_1998335_health_l_facility_id.x_1998335_health_l_name.toString(),
            license_type:
                gr.x_1998335_health_l_license_id.x_1998335_health_l_license_type.getDisplayValue(),
            days_before_expiry:
